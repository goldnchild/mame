...
const char *upd7810_base_disassembler::dasm_s::args() const
{
	return (m_token != prefix) ? reinterpret_cast<const char *>(m_args) : nullptr;
}

bool upd7810_base_disassembler::dasm_s::is_prefix() const
{
	return m_token == prefix;
}

bool upd7810_base_disassembler::dasm_s::is_call() const
{
	return (m_token == CALB) || (m_token == CALF) || (m_token == CALL) || (m_token == CALT);
}

bool upd7810_base_disassembler::dasm_s::is_return() const
{
	return (m_token == RET) || (m_token == RETI);
}
...
upd7810_base_disassembler::dasm_s::dasm_s() : m_token(illegal), m_args(nullptr)
{
}

upd7810_base_disassembler::dasm_s::dasm_s(uint8_t t, const char *a) : m_token(t), m_args(a)
{
}

upd7810_base_disassembler::dasm_s::dasm_s(const dasm_s (&a)[256]) : m_token(prefix), m_args(a)
{
}

const char *const upd7810_base_disassembler::dasm_s::token_names[] =
{
	"",
	"illegal",
	"ACI",
...
// prefix 60
const upd7810_base_disassembler::dasm_s upd7810_base_disassembler::d60[256] =
{
...
// prefix 70
const upd7810_base_disassembler::dasm_s upd7810_base_disassembler::d70[256] =
{
...
// prefix 74
const upd7810_base_disassembler::dasm_s upd7810_base_disassembler::d74[256] =
{
...
// prefix 48
const upd7810_base_disassembler::dasm_s upd7810_disassembler::d48_7810[256] =
{
...
// prefix 4D
const upd7810_base_disassembler::dasm_s upd7810_disassembler::d4D_7810[256] =
{
...
// prefix 64
const upd7810_base_disassembler::dasm_s upd7810_disassembler::d64_7810[256] =
{
...
// main opcodes
const upd7810_base_disassembler::dasm_s upd7810_disassembler::XX_7810[256] =
{
...
const upd7810_base_disassembler::dasm_s upd7807_disassembler::d48_7807[256] =
{
	{                  }, // 00: 0100 1000 0000 0000
	{SLRC,   "A"       }, // 01: 0100 1000 0000 0001
	{SLRC,   "B"       }, // 02: 0100 1000 0000 0010
...
const upd7810_base_disassembler::dasm_s upd7807_disassembler::d4C_7807[256] =
{
	{                  }, // 00: 0100 1100 0000 0000
	{                  }, // 01: 0100 1100 0000 0001
	{                  }, // 02: 0100 1100 0000 0010
...
const upd7810_base_disassembler::dasm_s upd7807_disassembler::d4D_7807[256] =
{
	{                  }, // 00: 0100 1101 0000 0000
	{                  }, // 01: 0100 1101 0000 0001
	{                  }, // 02: 0100 1101 0000 0010
...
const upd7810_base_disassembler::dasm_s upd7807_disassembler::d64_7807[256] =
{
	{MVI,    "PA,%b"   }, // 00: 0110 0100 0000 0000 xxxx xxxx
	{MVI,    "PB,%b"   }, // 01: 0110 0100 0000 0001 xxxx xxxx
	{MVI,    "PC,%b"   }, // 02: 0110 0100 0000 0010 xxxx xxxx
...
const upd7810_base_disassembler::dasm_s upd7807_disassembler::XX_7807[256] =
{
	{NOP,    nullptr   }, // 00: 0000 0000
	{LDAW,   "%a"      }, // 01: 0000 0001 oooo oooo
	{INX,    "SP"      }, // 02: 0000 0010
...
const upd7810_base_disassembler::dasm_s upd7801_disassembler::d48_7801[256] = {
	// 0x00 - 0x3F
...
const upd7810_base_disassembler::dasm_s upd7801_disassembler::d60_7801[256] = {
	// 0x00 - 0x3F
	{                  }, {                  }, {                  }, {                  },
	{                  }, {                  }, {                  }, {                  },
...
const upd7810_base_disassembler::dasm_s upd7801_disassembler::d64_7801[256] = {
	// 0x00 - 0x3F
	{                  }, {                  }, {                  }, {                  },
	{                  }, {                  }, {                  }, {                  },
...
const upd7810_base_disassembler::dasm_s upd7801_disassembler::d70_7801[256] = {
	// 0x00 - 0x3F
	{                  }, {                  }, {                  }, {                  },
	{                  }, {                  }, {                  }, {                  },
	{                  }, {                  }, {                  }, {                  },
...
const upd7810_base_disassembler::dasm_s upd7801_disassembler::d74_7801[256] = {
	// 0x00 - 0x3F
	{                  }, {                  }, {                  }, {                  },
	{                  }, {                  }, {                  }, {                  },
	{                  }, {                  }, {                  }, {                  },
...
const upd7810_base_disassembler::dasm_s upd78c05_disassembler::d48_78c05[256] = {
	// 0x00 - 0x3F
...
const upd7810_base_disassembler::dasm_s upd78c05_disassembler::d4C_78c05[256] = {
	// 0x00 - 0x3F
	{                  }, {                  }, {                  }, {                  },
	{                  }, {                  }, {                  }, {                  },
	{                  }, {                  }, {                  }, {                  },
	...
	{ MOV,     "A,S"   }, {                  }, {                  }, {                  }, // TODO: Figure out what register C9 indicates
	{                  }, {                  }, {                  }, {                  },
...
const upd7810_base_disassembler::dasm_s upd78c05_disassembler::d60_78c05[256] = {
	// 0x00 - 0x3F
	{                  }, {                  }, {                  }, {                  },
	{                  }, {                  }, {                  }, {                  },
	{                  }, { ANA,     "A,A"   }, {                  }, {                  },
...
const upd7810_base_disassembler::dasm_s upd78c05_disassembler::d64_78c05[256] = {
	// 0x00 - 0x3F
	{                  }, {                  }, {                  }, {                  },
	{                  }, {                  }, {                  }, {                  },
	{                  }, { ANI,     "A,%b"  }, {                  }, {                  },
...
const upd7810_base_disassembler::dasm_s upd78c05_disassembler::d70_78c05[256] = {
	// 0x00 - 0x3F
	{                  }, {                  }, {                  }, {                  },
	{                  }, {                  }, {                  }, {                  },
	{                  }, {                  }, {                  }, {                  },
...
const upd7810_base_disassembler::dasm_s upd78c05_disassembler::d74_78c05[256] = {
	// 0x00 - 0x3F
	{                  }, {                  }, {                  }, {                  },
	{                  }, {                  }, {                  }, {                  },
	{                  }, {                  }, {                  }, {                  },
...
offs_t upd7810_base_disassembler::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params)
{
	...
	uint32_t flags = desc->is_call() ? STEP_OVER : desc->is_return() ? STEP_OUT : 0;
	uint8_t op2;
	int offset;
	uint16_t ea;
	...
	return (idx - pc) | flags | SUPPORTED;
}

upd7810_base_disassembler::upd7810_base_disassembler(const dasm_s *table, bool is_7810) : m_is_7810(is_7810), m_dasmXX(table)
{
}

uint32_t upd7810_base_disassembler::opcode_alignment() const
{
	return 1;
}

upd7810_disassembler::upd7810_disassembler() : upd7810_base_disassembler(XX_7810, true)
{
}

upd7807_disassembler::upd7807_disassembler() : upd7810_base_disassembler(XX_7807, true)
{
}

upd7801_disassembler::upd7801_disassembler() : upd7810_base_disassembler(XX_7801, false)
{
}

upd78c05_disassembler::upd78c05_disassembler() : upd7810_base_disassembler(XX_78c05, false)
{
}
