...
INPUT_PORTS_START( pc6022 )
	...
	PORT_START("PB")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_KEYPAD ) PORT_NAME("Pen Right") PORT_CODE(KEYCODE_6_PAD)
	...
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_KEYPAD ) PORT_NAME("Pen Change") PORT_CODE(KEYCODE_3_PAD)
